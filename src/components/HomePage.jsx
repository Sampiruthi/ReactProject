...
const HomePage = () => {
  ...
  return (
    <div className="main">
        <div className='logo'>
            ...
            <h3 className='slogan'>Securing Tomorrows, Safeguarding Today: Your Life, Your Assurance!</h3>
    ...
    <Marquee className='marquee' style={{fontFamily:'unset',fontSize:'20px',color:'blue',cursor:'pointer',paddingTop:'15px'}} pauseOnHover={true} speed={100}>
        ...
        <AppBar position="static" style={{backgroundColor: 'plum'}}>
        <Container>
        <Toolbar>
  ...
  <div className='pic'>
       <img src='https://www.southjersey.aaa.com/sites/default/files/article_featured/life-insurance-900_0.jpg' style={{paddingTop:'5px'}}alt='none' width='1000px'></img>
    </div>
    <div>
    <Box
      component="footer"
